...
<div class="container-fluid">
    ...
    <div class="card-body px-0">
        ...
        <div><br>
            <h4 class="font-weight-medium fs-14 mb-0"> Products</h4>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page">Products</li>
            </ol>
            </nav>
        </div>
        <div>
                            ...
                            <?php
                                ...
                                ?>
                                    ...
                                    <tr class="search-items" 
                                        ...
                                        >
                                        <td>
                                            <a href="javascript:void(0);" class="view_product_details" data-id="<?= $row_product['product_id'] ?>">
