                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="productline" name="productline" class="form-control"  />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Line Abreviations</label>
                      <input type="text" id="lineAbreviations" name="lineAbreviations" class="form-control"  />
                    </div>
                  </div>
                </div>
