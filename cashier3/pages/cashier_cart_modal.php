            ...
            <table id="cartTable" class="table table-hover table-fixed mb-0">
                ...
                if (!empty($_SESSION["cart"])) {
                    foreach ($_SESSION["cart"] as $values) {
                        ...
                        if (!isset($grouped[$category][$bundle_name])) {
                            $grouped[$category][$bundle_name] = [];
                        }

                        $grouped[$category][$bundle_name][] = $values;
                    }

                    foreach ($grouped as $category_id => $bundleGroups) {
                        foreach ($bundleGroups as $bundle_name => $items) {
                            $hasBundleName = trim($bundle_name) !== '';
                            ?>
                            <tbody class="<?= $hasBundleName ? 'tbody-border' : '' ?>">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td colspan="2" class="text-center">Total Quantity: <span id="qty_ttl"><?= $total_qty ?></span></td>
                        <td colspan="1"></td>
