                    ...
                    >
                        ...
                        <td class="text-center" id="action-button-<?= $no ?>">
                            <?php if ($row_supplier_color['status'] == '0') { ?>
                                <a href="#" class="py-1 text-dark hideSupplierColor" title="Archive" data-id="<?= $id ?>" data-row="<?= $no ?>">
                                  <i class="text-danger ti ti-trash fs-7"></i>
                                </a>
                            <?php } else { ?>
                                <a href="#" id="addModalBtn" title="Edit" class="d-flex align-items-center justify-content-center text-decoration-none" data-id="<?= $id ?>" data-type="edit">
                                ...
                                success: function(response) {
                                    if (response == 'success') {
                                        if (status == 1) {
                                            ...
                                            $('#action-button-' + no).html('<a href="#" title="Archive" class="py-1 text-dark hideSupplierColor" data-id="' + id + '" data-row="' + no + '"><i class="text-danger ti ti-trash fs-7"></i></a>');
