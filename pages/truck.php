          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="display_trucks" class="table table-striped table-bordered align-middle">
                  <thead>
                    <tr>
                      <th>Truck Name</th>
                      <th>Description</th>
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="truckForm" class="form-horizontal">
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
...
<script>
  $(document).ready(function() {
    ...
    var table = $('#display_trucks').DataTable({
        pageLength: 100,
        ajax: {
            url: 'pages/truck_ajax.php',
            type: 'POST',
    ...
    $(document).on('click', '.hideTruck', function(event) {
        event.preventDefault();
        var id = $(this).data('id');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response == 'success') {
                    ...
                    alert('Failed to hide truck data.');
                }
            },
            error: function(jqXHR, textStatus, errorThrown) {
                alert('Error: ' + textStatus + ' - ' + errorThrown);
    ...
    $('#truckForm').on('submit', function(event) {
        event.preventDefault(); 
    ...
    $("#download_class_form").submit(function (e) {
        e.preventDefault();
        window.location.href = "pages/truck_ajax.php?action=download_classifications&class=" + encodeURIComponent($("#select-download-class").val());
    });
    ...
    $(document).on('click', '#downloadBtn', function(event) {
        window.location.href = "pages/truck_ajax.php?action=download_excel";
    });
    ...
    $(document).on('click', '#saveTable', function(event) {
        if (confirm("Are you sure you want to save this Excel data to the trucks data?")) {
