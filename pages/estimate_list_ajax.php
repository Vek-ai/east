...
if(isset($_REQUEST['action'])) {
    ...
    if ($action == "fetch_view_modal") {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            <style>
                ...
                #est_view_tbl td, #est_view_tbl th {
                            ...
                            <div class="card">
                                <div class="card-body datatables">
                                    <div class="estimate-details table-responsive text-nowrap">
                                        ...
                                        <table id="est_view_tbl" class="table table-hover mb-0 text-md-nowrap w-100">
                                            <thead>
                                                <tr>
    ...
    if ($action == "fetch_edit_modal") {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            <style>
                ...
                #est_edit_tbl td, #est_edit_tbl th {
                    white-space: normal !important;
                    word-wrap: break-word;
                }
            </style>
    ...
    if ($action == "send_email") {
        ...
        $sql = "UPDATE estimates SET status = '2', is_edited = '0' WHERE estimateid = $id";
        if (!mysqli_query($conn, $sql)) {
