            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table id="display_screw_coating" class="table table-striped table-bordered align-middle">
                    <thead>
                        <tr>
                            <th><?= $page_title ?></th>
                            <th>Abbreviation</th>
...
<script>
  $(document).ready(function() {
    ...
    var columns = [];
    columns.push({ data: 'product_screw_coating' });
    columns.push({ data: 'abbreviation' });
    ...
    var table = $('#display_screw_coating').DataTable({
        pageLength: 100,
        ajax: {
            url: 'pages/product_screw_coating_ajax.php',
            type: 'POST',
    ...
    $('#display_screw_coating_filter').hide();
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response == 'success') {
                    ...
                    alert('Failed to hide Screw Coating.');
                }
            },
            error: function(jqXHR, textStatus, errorThrown) {
                alert('Error: ' + textStatus + ' - ' + errorThrown);
        ...
        $.ajax({
            ...
            success: function(response) {
              ...
              if (response.trim() === "update-success") {
                  ...
                  $('#responseMsg').text("Screw Coating updated successfully.");
                  ...
                  $('#responseHeader').text("Success");
                  $('#responseMsg').text("New Screw Coating added successfully.");
                  $('#responseHeaderContainer').removeClass("bg-danger");
                  $('#responseHeaderContainer').addClass("bg-success");
                  $('#response-modal').modal("show");
                  table.ajax.reload(null, false);
    ...
    $(document).on('click', '#downloadBtn', function(event) {
        window.location.href = "pages/product_screw_coating_ajax.php?action=download_excel";
    });
    ...
    $(document).on('click', '#addModalBtn', function(event) {
        ...
        if(type == 'edit'){
          $('#add-header').html('Update Screw Coating');
        }else{
          $('#add-header').html('Add Screw Coating');
        }
