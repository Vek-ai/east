...
if(isset($_REQUEST['action'])) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $customer_farm_name = $row['customer_farm_name'] ?? '';
        ...
        $use_business = $row['use_business'] ?? '';
        $use_farm = $row['use_farm'] ?? '';
            ...
            <div class="card-body border rounded p-3">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="customer_farm_name" name="customer_farm_name" class="form-control"
                            value="<?= $customer_farm_name ?? '' ?>" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <label class="form-label">Use Business/Customer Name</label>
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="use_business" id="use_business" value="1" <?= ($use_business ?? '' == '1' ? 'checked' : '') ?>><br>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="use_farm" id="use_farm" value="1" <?= ($use_farm ?? '' == '1' ? 'checked' : '') ?>><br>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
