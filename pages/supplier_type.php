...
<div class="col-12">
  ...
  <div class="card card-body">
    <div class="row">
      <div class="col-3">
        <h4 class="card-title"><?= $addHeaderTxt ?> Supplier Type</h4>
      </div>
      <div class="col-9">
    ...
    <form id="supplierTypeForm" class="form-horizontal">
      ...
      <div class="form-actions">
        <div class="card-body border-top ">
          <input type="hidden" id="supplier_type_id" name="supplier_type_id" class="form-control"  value="<?= $supplier_type_id ?>"/>
          <div class="row">
