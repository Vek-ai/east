              ...
              <div class="position-relative w-100 px-1 mb-2">
                  <select class="form-control py-0 ps-5 select2 filter-selection" id="filter-supplier" data-filter="supplier" data-filter-name="Supplier">
                      ...
                      <optgroup label="Category">
                          ...
                          ?>
                              <option value="<?= $row_supplier['supplier_id'] ?>" data-supplier="<?= $row_supplier['supplier_id'] ?>" <?= $selected ?>><?= $row_supplier['supplier_name'] ?></option>
                          <?php   
                          }
                          ?>
                      </optgroup>
...
<script>
  $(document).ready(function() {
    ...
    $('#display_supplier_pack_filter').hide();
    ...
    $("#download_excel_form").submit(function (e) {
        e.preventDefault();
        window.location.href = "pages/supplier_pack_ajax.php?action=download_excel&category=" + encodeURIComponent($("#select-download-category").val());
    });

    $("#download_class_form").submit(function (e) {
        e.preventDefault();
        window.location.href = "pages/supplier_pack_ajax.php?action=download_classifications&class=" + encodeURIComponent($("#select-download-class").val());
    });
