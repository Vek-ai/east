<div class="font-weight-medium shadow-none position-relative overflow-hidden mb-7">
            <div class="card-body px-0">
              <div class="d-flex justify-content-between align-items-center">
                <div><br>
                  <h4 class="font-weight-medium fs-14 mb-0">Supplier Product list</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item text-muted" aria-current="page">Product list</li>
                    </ol>
                  </nav>
                </div>
                <div>
                  ...
                  <table class="table align-middle text-nowrap mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="../assets/images/products/s2.jpg" class="rounded-circle" alt="materialpro-img" width="56" height="56">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="../assets/images/products/s3.jpg" class="rounded-circle" alt="materialpro-img" width="56" height="56">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="../assets/images/products/s4.jpg" class="rounded-circle" alt="materialpro-img" width="56" height="56">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center">
                            <img src="../assets/images/products/s5.jpg" class="rounded-circle" alt="materialpro-img" width="56" height="56">
                            <div class="ms-3">
