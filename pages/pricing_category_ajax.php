...
if(isset($_REQUEST['action'])) {
    ...
    if ($action == "add_update") {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $updateQuery = "UPDATE pricing_category SET product_category_id = '$product_category_id', customer_pricing_id = '$customer_pricing_id', percentage = '$percentage', last_edit = NOW(), edited_by = '$userid'  WHERE id = '$id'";
            ...
            $insertQuery = "INSERT INTO pricing_category (product_category_id, customer_pricing_id, percentage, added_date, added_by) VALUES ('$product_category_id', '$customer_pricing_id', '$percentage', NOW(), '$userid')";
