...
$test_table = 'customer_pricing_excel';
        ...
        ?>
            <div class="row pt-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="pricing_name" name="pricing_name" class="form-control"  value="<?= $row['pricing_name'] ?? '' ?>"/>
                </div>
                </div>
                <div class="col-md-4">
                <div class="mb-3">
                    <label class="form-label">Pricing Abbreviation</label>
                    <input type="text" id="pricing_abbreviation" name="pricing_abbreviation" class="form-control"  value="<?= $row['pricing_abbreviation'] ?? '' ?>"/>
                </div>
                </div>
            </div>
