...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="lengthForm" class="form-horizontal">
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
...
<script>
  $(document).ready(function() {
    ...
    $('#display_length').on('xhr.dt', function (e, settings, json, xhr) {
        console.log("Raw response text:", xhr.responseText);
        console.log("Parsed JSON:", json);
    });

    $('#display_length_filter').hide();
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response == 'success') {
                    ...
                    alert('Failed to hide product length.');
                }
            },
            error: function(jqXHR, textStatus, errorThrown) {
                alert('Error: ' + textStatus + ' - ' + errorThrown);
    ...
    $('#lengthForm').on('submit', function(event) {
        event.preventDefault(); 
    ...
    $(document).on('click', '#saveTable', function(event) {
        if (confirm("Are you sure you want to save this Excel data to the product lengths data?")) {
