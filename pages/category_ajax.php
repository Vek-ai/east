    ...
    if ($action == "add_update") {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (!empty($duplicates)) {
                ...
                $updateQuery = "UPDATE product_category SET product_category = '$product_category', category_abreviations = '$category_abreviations', notes = '$notes', last_edit = NOW(), edited_by = '$userid'  WHERE product_category_id = '$product_category_id'";
            ...
            if(!empty($duplicates)){
                ...
                $insertQuery = "INSERT INTO product_category (product_category, category_abreviations, notes, added_date, added_by) VALUES ('$product_category', '$category_abreviations', '$notes', NOW(), '$userid')";
