                ...
                <div class="datatables">
                    <div class="table-responsive">
                        <div id="tbl-work-order" class="product-details table-responsive">
                            <table id="defeciveCoilsList" class="table search-table align-middle text-nowrap">
                                ...
                                <?php
                                    ...
                                    $query_coil = "
                                        ...
                                        WHERE 
                                            hidden = '0'
                                            AND tagged_defective = '1'
                                        ORDER BY 
                                            STR_TO_DATE(NULLIF(tagged_date, ''), '%Y-%m-%d') DESC
                                    ";  
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#defeciveCoilsList').DataTable({
            pageLength: 100
        });

        $('#defeciveCoilsList_filter').hide();
