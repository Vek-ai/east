            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table id="display_coil_condition" class="table table-striped table-bordered align-middle">
                    <thead>
                        <tr>
                            <th><?= $page_title ?></th>
                            <th>abbreviation</th>
...
<script>
  $(document).ready(function() {
    ...
    var columns = [];
        columns.push({ data: 'coil_condition' });
    ...
    var table = $('#display_coil_condition').DataTable({
        pageLength: 100,
        ajax: {
            url: 'pages/coil_condition_ajax.php',
            type: 'POST',
    ...
    $('#display_coil_condition_filter').hide();
    ...
    $("#download_excel_form").submit(function (e) {
        e.preventDefault();
        window.location.href = "pages/coil_condition_ajax.php?action=download_excel&category=" + encodeURIComponent($("#select-download-category").val());
    });

    $("#download_class_form").submit(function (e) {
        e.preventDefault();
        window.location.href = "pages/coil_condition_ajax.php?action=download_classifications&class=" + encodeURIComponent($("#select-download-class").val());
    });
