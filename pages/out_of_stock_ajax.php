...
if (isset($_POST['save_order'])) {
    ...
    $cashierid = intval($_SESSION['userid']);
    $supplier_id = intval($_SESSION['order_supplier_id'] ?? 0);
    $cart = $_SESSION['order_cart'];
    ...
    if ($conn->query($query)) {
        ...
        // Now execute the batch insert for all items
        $query = "INSERT INTO supplier_temp_prod_orders 
                  (supplier_temp_order_id, product_id, supplier_id, quantity, price, color) 
