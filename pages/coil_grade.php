          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="display_coil_grade" class="table table-striped table-bordered align-middle">
                  <thead>
                    <tr>
                      <th>Coil grade</th>
                      <th>Abreviations</th>
...
<script>
  $(document).ready(function() {
    ...
    var table = $('#display_coil_grade').DataTable({
        pageLength: 100,
        ajax: {
            url: 'pages/coil_grade_ajax.php',
            type: 'POST',
    ...
    $('#display_coil_grade_filter').hide();
    ...
    $(document).on('click', '.changeStatus', function(event) {
        ...
        var coil_grade_id = $(this).data('id');
    ...
    $("#download_excel_form").submit(function (e) {
        e.preventDefault();
        window.location.href = "pages/coil_grade_ajax.php?action=download_excel&category=" + encodeURIComponent($("#select-download-category").val());
    });

    $("#download_class_form").submit(function (e) {
        e.preventDefault();
        window.location.href = "pages/coil_grade_ajax.php?action=download_classifications&class=" + encodeURIComponent($("#select-download-class").val());
    });
