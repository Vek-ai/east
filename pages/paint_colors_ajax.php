    ...
    if ($action == "add_update") {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (!empty($duplicates)) {
                ...
                $updateQuery = "UPDATE paint_colors SET color_name = '$color_name', color_code = '$color_code', ekm_color_no = '$ekm_color_no', ekm_paint_code = '$ekm_paint_code', color_group = '$color_group', provider_id = '$provider_id', last_edit = NOW(), edited_by = '$userid', ekm_color_code = '$ekm_color_code', color_abbreviation = '$color_abbreviation', stock_availability = '$stock_availability', multiplier_category = '$multiplier_category'  WHERE color_id = '$color_id'";
            ...
            if(!empty($duplicates)){
                ...
                $insertQuery = "INSERT INTO paint_colors (color_name, color_code, ekm_color_no, ekm_paint_code, color_group, provider_id, added_date, added_by, ekm_color_code, color_abbreviation, stock_availability, multiplier_category) VALUES ('$color_name', '$color_code', '$ekm_color_no', '$ekm_paint_code', '$color_group', '$provider_id', NOW(), '$userid', '$ekm_color_code', '$color_abbreviation', '$stock_availability', '$multiplier_category')";
