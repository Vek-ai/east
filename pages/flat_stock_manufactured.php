...
<div class="font-weight-medium shadow-none position-relative overflow-hidden mb-7">
    <div class="card-body px-0">
        ...
        <div>
            <h4 class="font-weight-medium fs-14 mb-0">Flat Stock Manufactured</h4>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page">Flat Stock Manufactured</li>
            </ol>
            </nav>
        </div>
        <div>
        ...
        <div class="card-body text-center p-3">
            <div class="d-flex justify-content-between align-items-center  mb-9">
                <div class="position-relative w-100 col-8">
                    <input type="text" class="form-control search-chat py-2 ps-5 ms-0" id="text-srh" placeholder="Search Flat Stock">
...
$(document).ready(function() {
    ...
    function performSearch(query) {
        ...
        $.ajax({
            url: 'pages/flat_stock_manufactured_ajax.php',
            type: 'POST',
            data: {
                query: query,
    ...
    $(document).on('click', '#viewAddInvModal', function(event) {
        ...
        $.ajax({
                ...
                data: {
                    id: id,
                    fetch_add_warehouse: "fetch_add_warehouse"
                },
                success: function(response) {
                    $('#addInventoryModal').html(response);
                    $(".select2-add").select2({
    ...
    $(document).on('change', '#Row_id, #Bin_id, #Shelves_id', function() {
        if (isClearing) return;
        const selectedId = $(this).attr('id');
        
        isClearing = true;

        $('#Row_id, #Bin_id, #Shelves_id').not(`#${selectedId}`).each(function() {
