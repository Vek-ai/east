...
if(!empty($_REQUEST['result'])){
  if($_REQUEST['result'] == '1'){
    $message = "New product profile type added successfully.";
...
<div class="col-12">
  ...
  <div class="card card-body">
    <div class="row">
      <div class="col-3">
        <h4 class="card-title"><?= $addHeaderTxt ?> Profile type</h4>
      </div>
      <div class="col-9">
      ...
      <div class="row pt-3">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="text" id="profile_abbreviations" name="profile_abbreviations" class="form-control" value="<?= $profile_abbreviations ?>" />
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          ...
          <table id="display_profile_type" class="table table-striped table-bordered text-nowrap align-middle">
            <thead>
              <!-- start row -->
              <tr>
                <th>Profile type</th>
            ...
            success: function(response) {
                if (response == 'success') {
                    if (status == 1) {
                        ...
                        $('#action-button-' + no).html('<a href="#" class="btn btn-light py-1 text-dark hideProfileType" data-id="' + profile_type_id + '" data-row="' + no + '" style="border-radius: 10%;">Archive</a>');
