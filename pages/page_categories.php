          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="page_categories" class="table table-striped table-bordered align-middle">
                  <thead>
                    <tr>
                      <th>Category Name</th>
                      <th>Description</th>
...
<script>
  $(document).ready(function() {
    ...
    var table = $('#page_categories').DataTable({
        pageLength: 100,
        ajax: {
            url: 'pages/page_categories_ajax.php',
            type: 'POST',
