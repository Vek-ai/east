...
$test_table = 'product_system_excel';
...
if(isset($_REQUEST['action'])) {
    ...
    if ($action == 'fetch_modal_content') {
        ...
        <div class="row pt-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="product_system" name="product_system" class="form-control"  value="<?= $row['product_system'] ?? '' ?>"/>
            </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
        ...
        <div class="row pt-3">
            <div class="col-md-6">
            <div class="mb-3">
                <label class="form-label">System Abbreviations</label>
                <input type="text" id="system_abbreviations" name="system_abbreviations" class="form-control" value="<?= $row['system_abbreviations'] ?? '' ?>" />
            </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
    ...
    if ($action === 'fetch_table') {
        $query = "SELECT * FROM product_system WHERE hidden = 0";
        $result = mysqli_query($conn, $query);
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($permission === 'edit') {
                ...
                $action_html = $row['status'] == '0'
                    ? "<a href='javascript:void(0)' class='py-1 text-dark hideSystem' title='Archive' data-id='$no' data-row='$no' style='border-radius: 10%;'>
