...
$columns = [
    ['label' => 'DESCRIPTION', 'width' => 27, 'align' => 'C', 'fontsize' => 9], // +3
    ['label' => 'COLOR',       'width' => 23, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'GRADE',       'width' => 20, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'GAUGE',       'width' => 15, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'QTY',         'width' => 15, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'LENGTH',      'width' => 15, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'TYPE',        'width' => 19, 'align' => 'C', 'fontsize' => 9], // +3
    ['label' => 'STYLE',       'width' => 19, 'align' => 'C', 'fontsize' => 9], // +3
    ['label' => 'PRICE',       'width' => 23, 'align' => 'R', 'fontsize' => 9], // +2
    ['label' => 'TOTAL',       'width' => 23, 'align' => 'R', 'fontsize' => 9], // +2
];
...
class PDF extends FPDF {
    ...
    public function renderRow($columns, $row, $bold = false, $note = '') {
        ...
        foreach ($columns as $i => $col) {
            ...
            if ($i === 5 && strpos($row[$i], 'ft') !== false && strpos($row[$i], 'in') !== false) {
...
if (mysqli_num_rows($result) > 0) {
    while($row_orders = mysqli_fetch_assoc($result)){
        ...
        $pdf->salesperson = get_staff_name($row_orders['cashier']);
        $pdf->token = $token;
