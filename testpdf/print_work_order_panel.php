...
$columns = [
    ['label' => 'DESCRIPTION', 'width' => 37, 'align' => 'C', 'fontsize' => 9], // +10
    ['label' => 'COLOR',       'width' => 23, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'GRADE',       'width' => 20, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'GAUGE',       'width' => 20, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'QTY',         'width' => 20, 'align' => 'C', 'fontsize' => 9], // +1
    ['label' => 'LENGTH',      'width' => 18, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'TYPE',        'width' => 20, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'STYLE',       'width' => 20, 'align' => 'C', 'fontsize' => 9], // +2
    ['label' => 'COIL #',      'width' => 21, 'align' => 'C', 'fontsize' => 9], // +2
];
...
function renderRow($pdf, $columns, $row, $bold = false) {
    ...
    foreach ($columns as $i => $col) {
        ...
        } elseif ($i === 6 && stripos($row[$i], 'Vented') !== false) {
            $cellBold = true;
        } elseif ($i === 7) {
        ...
        } elseif ($i === 5 && strpos($row[$i], 'ft') !== false && strpos($row[$i], 'in') !== false) {
...
if (mysqli_num_rows($result) > 0) {
    ...
    $query_product = "
        ...
        AND op.product_category IN ('$panel_id')
    ...
    $pdf->SetTitle('Panel Work Order');
    $pdf->Output('Panel Work Order.pdf', 'I');
