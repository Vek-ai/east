            ...
            <div class="card card-body">
              ...
              <form class="form-horizontal">
                ...
                <div class="row pt-3">
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="productCategory" name="productCategory" id="inlineFormCustomSelect">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="productLine" name="productLine" id="inlineFormCustomSelect">
                        <option selected>Choose...</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="productType" name="productType" id="inlineFormCustomSelect">
                        <option selected>Choose...</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" id="supplierWebsite" name="supplierWebsite" class="form-control"  />
                </div>
                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="stockType" name="stockType" id="inlineFormCustomSelect">
                        <option selected>Choose...</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="lastSoldDate" name="lastSoldDate" class="form-control"  />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
