...
$stmt = $conn->prepare("SELECT staff_id, staff_fname, staff_lname, username FROM staff WHERE staff_id != :current_user ORDER BY staff_fname, staff_lname");
...
$conversations_query = "
    SELECT 
        ...
        (SELECT COUNT(*) FROM messages WHERE conversation_id = c.conversation_id AND sender_id != :current_user AND is_read = 0) as unread_count,
